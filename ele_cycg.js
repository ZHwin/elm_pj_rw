 ...
 * 2023.6.16 更新：新增买房置地和升级称号任务，增加领取部分任务奖励;修改环境变量为 elmck
 * 2023.6.19 更新：新增知识百科游戏
 * 2023.7.7 更新：添加限制
 * 2023.7.9 更新：删除知识百科，只保留成语闯关。通关后也可继续领取游戏奖励，提升每天的金币收入
 */
...
async function pageview(_0x164b86, _0x35b682, _0x3b36a8, _0x41608a) {
  ...
  const _0x13235b = _0x4518c3["split"]('_')[0];
...
async function gameRequest(_0x25b69b, _0x159f68) {
  ...
  const _0x4448ad = _0x1102f0["split"]('_')[0];
...
async function receive_task(_0x1bf124, _0x59b767, _0x1ec318) {
  ...
  const _0x186ef0 = _0x3b4443["split"]('_')[0];
...
async function query_task(_0x5b3ab4) {
  ...
  const _0x3ed92a = _0x2b4c11["split"]('_')[0];
...
async function exchangeList(_0x323a0e) {
  ...
  const _0x3a9ed1 = _0x2dc751["split"]('_')[0];
...
async function exchange(_0x27459a, _0x21e9ce) {
  ...
  const _0x4d850e = _0x5758cc["split"]('_')[0];
