...
async function gameRequest(_0x108364, _0x2cb520) {
  ...
  const _0x22503b = _0x1fece0["split"]('_')[0];
...
function addjb(_0x22cd6d, _0x5c6186) {
  ...
  let _0x1be390 = taobaoRequest({
    ...
    'mini_game_grant_integral_request': {
      ...
      'request_id': md5("dcc2920acdae1fdea78cef9c187af55820" + moment()["format"]("yyyy-MM-DD hh:mm:ss"))["toUpperCase"](),
      'property_id': "1404",
      'open_id': _0x5c6186
    }
  });
...
function sortASCII(_0x4a5215, _0x510c13) {
  ...
  var _0x741edb = {};
  for (var _0x457db9 in _0x28d2fa) {
    _0x741edb[_0x28d2fa[_0x457db9]] = _0x4a5215[_0x28d2fa[_0x457db9]];
  }
  return _0x741edb;
}
function taobaoRequest(_0x178a27) {
  const _0x1b3317 = "0|7|1|4|3|6|2|5"["split"]('|');
  ...
  for (var _0x41f90f in _0x178a27) {
    Object["prototype"]["hasOwnProperty"]["call"](_0x178a27, _0x41f90f) && ("object" == typeof _0x178a27[_0x41f90f] ? _0x5bf7ee[_0x41f90f] = JSON["stringify"](_0x178a27[_0x41f90f]) : _0x5bf7ee[_0x41f90f] = _0x178a27[_0x41f90f]);
  }
  _0x5bf7ee = sortASCII(_0x5bf7ee, true);
  var _0x3753c2 = '';
  for (var _0x41f90f in _0x5bf7ee) {
    Object["prototype"]["hasOwnProperty"]["call"](_0x5bf7ee, _0x41f90f) && (_0x3753c2 += _0x41f90f, "object" == typeof _0x5bf7ee[_0x41f90f] ? _0x3753c2 += JSON["stringify"](_0x5bf7ee[_0x41f90f]) : _0x3753c2 += _0x5bf7ee[_0x41f90f]);
  }
